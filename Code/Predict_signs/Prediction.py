def pred_main():
    ...
    # Function to translate formed word into Kannada
    def translate_to_kannada(word):
        translation = translator.translate(word, src='en', dest='kn')  # Translate word from English to Kannada
        return translation.text
    def translate_to_Hindi(word):
        translation = translator.translate(word, src='en', dest='hi')  # Translate word from English to Kannada
        return translation.text
    ...
    while(cam.isOpened()):
                        ...
                        if res is not None and cv2.contourArea(max_cont) > 1000:
                            ...
                            if (count > 10 and count <= 50):
                                ...
                                if len(result_list):
                                    ...
                                    if predict_sign is not None:
                                        formed_word += predict_sign
        ...
        if (k==27):
           break
        elif k == ord('B') or k == ord('b'):  # 'B' key pressed
            formed_word = formed_word[:-1] 
        elif k == ord('p') or k == ord('P'):
            kannada_word = translate_to_kannada(formed_word)
            Hindi_word=translate_to_Hindi(formed_word)
            print(kannada_word)
            print(Hindi_word)
