...
data = pd.read_csv("Classification/csv_files/train.csv", low_memory=False)
data.head()

test = pd.read_csv("Classification/csv_files/test.csv", low_memory=False)
test.head()
...
file_name = "Predict_signs/files/SVM"
